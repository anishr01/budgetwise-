...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
    ...
    // =================================================
    // 1️⃣ CATEGORY-WISE EXPENSE (PIE CHART)
    // =================================================
    @Query("""
    ...
    // =================================================
    // 5️⃣ MONTHLY SPENDING TREND (LINE CHART)
    // =================================================
    @Query("""
